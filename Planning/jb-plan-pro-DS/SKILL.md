...
**When NOT to use:** small tasks you'll just do now; pure research/exploration with no build; when the orchestrator is Opus (use `jb-plan`); when the human wants you to implement in this same session.
...
## How this differs from jb-plan

| Aspect | jb-plan (Opus) | jb-plan-pro-DS (V4 Pro) |
|---|---|---|
